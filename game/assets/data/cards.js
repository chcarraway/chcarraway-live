var cards = [
  ...
  },
  {
    ...
    header: "Prime Time",
    body:
      "All players must reveal their latest Amazon purchase. The player with the most expensive item must drink!"
  },
  {
    category: "Single",
  ...
  // Loser/Winner Drinks
  {
    ...
    body:
      "All of these cards include a contest to determine which player drinks!",
    nac: "nac"
  },
  {
    category: "Contest",
  ...
  },
  {
    ...
    header: "Rhyme Time",
    body:
      "Say a word. The next player must say a word that rhymes with it. Go around the circle until someone fails. That player drinks!"
  },
  {
    category: "Contest",
    header: "1, 2, 3, 4...",
  ...
  },
  {
    ...
    header: "Survey Says!",
    body:
      "Create a category. The player to your left must name an object in that category. This continues until a player can't come up with anything, that player drinks!"
  },
  {
    category: "Contest",
  ...
  },
  {
    ...
    header: "Avalanche!",
    body:
      "Choose a direction, and everyone starts drinking. The player beside you in that direction can't stop until you do, that player's neighbor can't stop until they do, etc..."
  },
  {
    category: "Multi",
    header: "Twinsies!",
  ...
  },
  {
    ...
    body:
      "Play a round of Never Have I Ever. All players must drink if they have done the thing!"
  },
  {
    category: "Multi",
  ...
  },
  {
    ...
    body:
      "All players must show off their tattoos and take a drink. If any player is unwilling to show one, they must take a shot instead."
  },
  {
    category: "Multi",
  ...
  },
  {
    ...
    body:
      "All players must produce physical currency that they own. Any player who cannot must drink!"
  },
  {
    category: "Multi",
    header: "Game Over",
  ...
  },
  {
    ...
    header: "Nerd Check",
    body:
      "Any players who have never leveled a World of Warcraft character past level 20 must drink!",
    contrib: "Jeremiah Emerson Williams"
  },
  {
    category: "Multi",
  ...
  },
  {
    ...
    body:
      "Any players who don't have the Starbucks app on their phones must drink!"
  },
  ...
  // Replacement Effects
  {
    ...
    body:
      "These cards change the way the game works, temporarily changing the rules until the conditions are met.",
    nac: "nac"
  },
  {
    category: "Replacement",
    ...
    body:
      "The next player that has to drink is not allowed to touch their cup. You must pour the drink in their mouth."
  },
  {
    category: "Replacement",
    header: "No Alcohol Beyond This Point",
    body:
      "The next time a player wishes to leave the room, they must finish their drink before being allowed to do so."
  },
  {
    category: "Replacement",
    header: "Get Down Mr. President!",
    body:
      "The next time a player has to take a shot, you must take it for them!"
  },
  {
    category: "Replacement",
    header: "Aw, Shoot!",
  ...
  },
  {
    ...
    body:
      "Create a rule that lasts for 5 rounds. If any player breaks that rule, they drink!",
    decay: 5
  },
  {
    category: "Ongoing",
    ...
    body:
      "Aliens are invading, and hanging out on top of your drinks! Every time you drink for the next 3 rounds, you must remove the little green man or else you drink again!",
    decay: 3,
  ...
  },
  {
    ...
    header: '"Jeffrey..."',
    body:
      "Whenever a player speaks to another player for the next 2 rounds, that player must say that player's name before AND after their statement. If that player forgets, they must drink!",
    decay: 2,
    contrib: "CheeksAdam"
  },
  {
    ...
    body:
      "Hold hands with the player to your right until your next turn. If you break hands, both players drink!",
    decay: 1
  },
  {
    category: "Ongoing",
    header: "For Valhalla!",
    body:
      "For the next 3 rounds, you are the Viking. Whenever you put your horns up (place fingers up by head), all other players must paddle twice on each side and then put their horns up. Last player to do so must drink!",
    decay: 3,
    contrib: "Kriseevee"
  },
  {
    ...
    body:
      "Until your next turn, you must try to make the other players laugh. If any other player laughs, all of them must drin! If no other players laugh before your next turn, you must take a shot!",
    decay: 1
  },
  // Do X or Drink
  {
    category: "Doit",
    header: "Do It or Drink!",
    body:
      "These cards give you the option of either taking an action or drinking.",
    nac: "nac"
  },
  {
    category: "Doit",
    header: "Don't Call Me Maybe",
    body:
      "Call your most recent ex on speaker and have a 2 minute conversation with them. If you choose not to, you must take a shot!"
  },
  {
    category: "Doit",
    header: "Push It",
    body:
      "Do a pushup for each player in the game. If you are unable to, or choose not to, you must drink for each player you didn't perform a pushup for."
  },
  {
    category: "Doit",
    header: "This One Time...",
    body:
      "Tell the story of your most recent sexual encounter. If you choose not to, you musht drink!"
  }
];
